- My personal note: the project is cloned from [DevOps-Projects](https://github.com/ophircloud/DevOps-Project), and I'll use the repo to develop my DevOps skill after I finish the next projects I have in mind. 
